...
public abstract class EmsSession_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.zx.emsSession.EmsSession_IOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "getEventChannel", new java.lang.Integer(3));
		m_opsHash.put ( "getManager", new java.lang.Integer(4));
		m_opsHash.put ( "getSupportedManagers", new java.lang.Integer(5));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			org.omg.zx.session.Session_IHelper.write(_out,associatedSession());
				break;
			}
			case 1: // endSession
			{
			...
			try
			{
				...
				org.omg.zx.common.Common_IHolder _arg1= new org.omg.zx.common.Common_IHolder();
				_out = handler.createReply();
				getManager(_arg0,_arg1);
				org.omg.zx.common.Common_IHelper.write(_out,_arg1.value);
			}
			catch(org.omg.zx.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			case 5: // getSupportedManagers
			{
			try
			{
				org.omg.zx.emsSession.EmsSession_IPackage.managerNames_THolder _arg0= new org.omg.zx.emsSession.EmsSession_IPackage.managerNames_THolder();
				_out = handler.createReply();
				getSupportedManagers(_arg0);
				org.omg.zx.emsSession.EmsSession_IPackage.managerNames_THelper.write(_out,_arg0.value);
			}
			catch(org.omg.zx.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
