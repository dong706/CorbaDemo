...
public final class PMParameterList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.performance.PMParameterList_THelper.id(), "PMParameterList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.zx.performance.PMParameter_THelper.type()));
		}
		return _type;
	}
