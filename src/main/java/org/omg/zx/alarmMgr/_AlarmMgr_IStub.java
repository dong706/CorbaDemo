...
public class _AlarmMgr_IStub
	...
	implements org.omg.zx.alarmMgr.AlarmMgr_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.alarmMgr.AlarmMgr_IOperations.class;
	...
	public void getPerceivedSeverities(org.omg.zx.alarmMgr.SeverityAssignmentList_THolder severityAssignmentList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "getPerceivedSeverities", true);
				_is = _invoke(_os);
				severityAssignmentList.value = org.omg.zx.alarmMgr.SeverityAssignmentList_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
	...
	public void setAlarmReportingOff(org.omg.zx.alarmMgr.ObjectAndRate_T[] objectAndRateList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.zx.alarmMgr.ObjectAndRateList_THelper.write(_os,objectAndRateList);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
	...
	public void setPerceivedSeverities(org.omg.zx.alarmMgr.SeverityAssignment_T[] severityAssignmentList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				org.omg.CORBA.portable.OutputStream _os = _request( "setPerceivedSeverities", true);
				org.omg.zx.alarmMgr.SeverityAssignmentList_THelper.write(_os,severityAssignmentList);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
