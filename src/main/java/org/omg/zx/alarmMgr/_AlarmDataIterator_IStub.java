...
public class _AlarmDataIterator_IStub
	...
	implements org.omg.zx.alarmMgr.AlarmDataIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.alarmMgr.AlarmDataIterator_IOperations.class;
	public boolean next_n(int how_many, org.omg.zx.alarmMgr.AlarmDataList_THolder alarmDataList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				alarmDataList.value = org.omg.zx.alarmMgr.AlarmDataList_THelper.read(_is);
				return _result;
			}
