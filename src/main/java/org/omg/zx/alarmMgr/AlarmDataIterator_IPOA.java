...
public abstract class AlarmDataIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.zx.alarmMgr.AlarmDataIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.zx.alarmMgr.AlarmDataList_THolder _arg1= new org.omg.zx.alarmMgr.AlarmDataList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				org.omg.zx.alarmMgr.AlarmDataList_THelper.write(_out,_arg1.value);
			}
