	...
	extends SubnetworkIterator_IPOA
{
	...
	public org.omg.zx.multiLayerSubnetwork.SubnetworkIterator_I _this()
	{
		return org.omg.zx.multiLayerSubnetwork.SubnetworkIterator_IHelper.narrow(_this_object());
	}
	public org.omg.zx.multiLayerSubnetwork.SubnetworkIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.zx.multiLayerSubnetwork.SubnetworkIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.omg.zx.multiLayerSubnetwork.SubnetworkList_THolder subnetworkList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
