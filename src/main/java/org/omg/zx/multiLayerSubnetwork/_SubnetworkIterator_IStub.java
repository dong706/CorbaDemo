...
public class _SubnetworkIterator_IStub
	...
	implements org.omg.zx.multiLayerSubnetwork.SubnetworkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.multiLayerSubnetwork.SubnetworkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.zx.multiLayerSubnetwork.SubnetworkList_THolder subnetworkList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				subnetworkList.value = org.omg.zx.multiLayerSubnetwork.SubnetworkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
