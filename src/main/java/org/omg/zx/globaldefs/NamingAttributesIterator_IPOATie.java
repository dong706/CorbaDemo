	...
	extends NamingAttributesIterator_IPOA
{
	...
	public org.omg.zx.globaldefs.NamingAttributesIterator_I _this()
	{
		return org.omg.zx.globaldefs.NamingAttributesIterator_IHelper.narrow(_this_object());
	}
	public org.omg.zx.globaldefs.NamingAttributesIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.zx.globaldefs.NamingAttributesIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.omg.zx.globaldefs.NamingAttributesList_THolder nameList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
