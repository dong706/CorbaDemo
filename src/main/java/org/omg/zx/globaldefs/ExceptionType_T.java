	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public static final int _EXCPT_SUBSCRIBERID_INVALID = 16;
	public static final ExceptionType_T EXCPT_SUBSCRIBERID_INVALID = new ExceptionType_T(_EXCPT_SUBSCRIBERID_INVALID);
	public static final int _EXCPT_OBJECT_NOT_EXIST = 17;
	public static final ExceptionType_T EXCPT_OBJECT_NOT_EXIST = new ExceptionType_T(_EXCPT_OBJECT_NOT_EXIST);
	public int value()
	{
		return value;
	}
	public static ExceptionType_T from_int(int value)
	{
		switch (value) {
			...
			case _EXCPT_SUBSCRIBERID_INVALID: return EXCPT_SUBSCRIBERID_INVALID;
			case _EXCPT_OBJECT_NOT_EXIST: return EXCPT_OBJECT_NOT_EXIST;
