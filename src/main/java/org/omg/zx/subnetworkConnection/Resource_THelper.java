...
public final class Resource_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.subnetworkConnection.Resource_THelper.id(), "Resource_T",org.omg.zx.globaldefs.NamingAttributes_THelper.type());
		}
		return _type;
	}
