...
public class _CCIterator_IStub
	...
	implements org.omg.zx.subnetworkConnection.CCIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.subnetworkConnection.CCIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.zx.subnetworkConnection.CrossConnectList_THolder ccList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				ccList.value = org.omg.zx.subnetworkConnection.CrossConnectList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
