...
public class _TopologicalLinkIterator_IStub
	...
	implements org.omg.zx.topologicalLink.TopologicalLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.topologicalLink.TopologicalLinkIterator_IOperations.class;
	public boolean next_n(int how_many, org.omg.zx.topologicalLink.TopologicalLinkList_THolder topoLinkList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				topoLinkList.value = org.omg.zx.topologicalLink.TopologicalLinkList_THelper.read(_is);
				return _result;
			}
