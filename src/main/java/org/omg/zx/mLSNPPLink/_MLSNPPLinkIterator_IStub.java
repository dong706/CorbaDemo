...
public class _MLSNPPLinkIterator_IStub
	...
	implements org.omg.zx.mLSNPPLink.MLSNPPLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.mLSNPPLink.MLSNPPLinkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.zx.mLSNPPLink.MLSNPPLinkList_THolder mLSNPPLinkList) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		else
		{
			...
			boolean _result;			try
			{
			_result = _localServant.next_n(how_many,mLSNPPLinkList);
			}
			finally
			{
				_servant_postinvoke(_so);
