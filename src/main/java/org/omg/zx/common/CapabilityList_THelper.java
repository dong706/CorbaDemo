...
public final class CapabilityList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.common.CapabilityList_THelper.id(), "CapabilityList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.zx.common.Capability_THelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.zx.globaldefs.NameAndStringValue_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.zx.globaldefs.NameAndStringValue_T[_l_result7];
