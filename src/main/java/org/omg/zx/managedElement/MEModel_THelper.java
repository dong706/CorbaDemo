...
public final class MEModel_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.zx.managedElement.MEModel_THelper.id(),"MEModel_T",new String[]{"MM_VIRTUAL","MM_PHYSICA","MM_LOGICAL"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.zx.managedElement.MEModel_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.zx.managedElement.MEModel_T extract (final org.omg.CORBA.Any any)
	{
