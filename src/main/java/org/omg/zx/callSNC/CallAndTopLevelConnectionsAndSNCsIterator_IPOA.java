...
public abstract class CallAndTopLevelConnectionsAndSNCsIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.zx.callSNC.CallAndTopLevelConnectionsAndSNCsIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.zx.callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder _arg1= new org.omg.zx.callSNC.CallAndTopLevelConnectionsAndSNCsList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				org.omg.zx.callSNC.CallAndTopLevelConnectionsAndSNCsList_THelper.write(_out,_arg1.value);
			}
			catch(org.omg.zx.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
