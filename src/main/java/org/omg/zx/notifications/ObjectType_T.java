	...
	implements org.omg.CORBA.portable.IDLEntity
{
	...
	public static final int _OT_TRAIL_NETWORK_PROTECTION = 13;
	public static final ObjectType_T OT_TRAIL_NETWORK_PROTECTION = new ObjectType_T(_OT_TRAIL_NETWORK_PROTECTION);
	public int value()
	{
		return value;
	}
	public static ObjectType_T from_int(int value)
	{
		switch (value) {
			...
			case _OT_TRAIL_NETWORK_PROTECTION: return OT_TRAIL_NETWORK_PROTECTION;
