...
public final class ObjectType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.zx.notifications.ObjectType_THelper.id(),"ObjectType_T",new String[]{"OT_EMS","OT_MANAGED_ELEMENT","OT_MULTILAYER_SUBNETWORK","OT_TOPOLOGICAL_LINK","OT_SUBNETWORK_CONNECTION","OT_PHYSICAL_TERMINATION_POINT","OT_CONNECTION_TERMINATION_POINT","OT_TERMINATION_POINT_POOL","OT_EQUIPMENT_HOLDER","OT_EQUIPMENT","OT_PROTECTION_GROUP","OT_TRAFFIC_DESCRIPTOR","OT_AID","OT_TRAIL_NETWORK_PROTECTION"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.zx.notifications.ObjectType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.zx.notifications.ObjectType_T extract (final org.omg.CORBA.Any any)
	{
