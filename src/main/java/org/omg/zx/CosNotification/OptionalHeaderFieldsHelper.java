...
public final class OptionalHeaderFieldsHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.CosNotification.OptionalHeaderFieldsHelper.id(), "OptionalHeaderFields",org.omg.zx.CosNotification.PropertySeqHelper.type());
		}
		return _type;
	}
