...
public final class FilterableEventBodyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.CosNotification.FilterableEventBodyHelper.id(), "FilterableEventBody",org.omg.zx.CosNotification.PropertySeqHelper.type());
		}
		return _type;
	}
