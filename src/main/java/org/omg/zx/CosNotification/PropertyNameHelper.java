...
public final class PropertyNameHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.CosNotification.PropertyNameHelper.id(), "PropertyName",org.omg.zx.CosNotification.IstringHelper.type());
		}
		return _type;
	}
