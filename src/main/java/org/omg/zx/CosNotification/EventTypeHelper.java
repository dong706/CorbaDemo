...
public final class EventTypeHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.zx.CosNotification.EventTypeHelper.id(),"EventType",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("domain_name", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("type_name", org.omg.CORBA.ORB.init().create_string_tc(0), null)});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.zx.CosNotification.EventType s)
	{
		any.type(type());
	...
	public static org.omg.zx.CosNotification.EventType read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.zx.CosNotification.EventType result = new org.omg.zx.CosNotification.EventType();
		result.domain_name=in.read_string();
		result.type_name=in.read_string();
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.zx.CosNotification.EventType s)
	{
