...
public class _QoSAdminStub
	...
	implements org.omg.zx.CosNotification.QoSAdmin
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.CosNotification.QoSAdminOperations.class;
	public void set_qos(org.omg.zx.CosNotification.Property[] qos) throws org.omg.zx.CosNotification.UnsupportedQoS
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.zx.CosNotification.PropertySeqHelper.write(_os,qos);
				_is = _invoke(_os);
				return;
			}
			...
			catch( org.omg.CORBA.portable.ApplicationException _ax )
			{
				...
				{
					throw org.omg.zx.CosNotification.UnsupportedQoSHelper.read(_ax.getInputStream());
				}
				else 
	...
	public void validate_qos(org.omg.zx.CosNotification.Property[] required_qos, org.omg.zx.CosNotification.NamedPropertyRangeSeqHolder available_qos) throws org.omg.zx.CosNotification.UnsupportedQoS
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.zx.CosNotification.PropertySeqHelper.write(_os,required_qos);
				_is = _invoke(_os);
				available_qos.value = org.omg.zx.CosNotification.NamedPropertyRangeSeqHelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
