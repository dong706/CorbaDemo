...
public final class TNAList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.zx.mLSNPP.TNAList_THelper.id(), "TNAList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.zx.mLSNPP.TNAName_THelper.type()));
		}
		return _type;
	}
