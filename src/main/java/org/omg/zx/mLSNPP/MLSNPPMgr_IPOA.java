...
public abstract class MLSNPPMgr_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.zx.mLSNPP.MLSNPPMgr_IOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(0));
		m_opsHash.put ( "setTNANameForMLSNPP", new java.lang.Integer(1));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.zx.mLSNPP.MultiLayerSNPP_THolder _arg5= new org.omg.zx.mLSNPP.MultiLayerSNPP_THolder();
				_out = handler.createReply();
				setTNANameForMLSNPP(_arg0,_arg1,_arg2,_arg3,_arg4,_arg5);
				org.omg.zx.mLSNPP.MultiLayerSNPP_THelper.write(_out,_arg5.value);
			}
			catch(org.omg.zx.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
			...
			{
				org.omg.zx.globaldefs.NameAndStringValue_T[] _arg0=org.omg.zx.globaldefs.NVSList_THelper.read(_input);
				org.omg.zx.mLSNPP.MultiLayerSNPP_THolder _arg1= new org.omg.zx.mLSNPP.MultiLayerSNPP_THolder();
				_out = handler.createReply();
				getMLSNPP(_arg0,_arg1);
				org.omg.zx.mLSNPP.MultiLayerSNPP_THelper.write(_out,_arg1.value);
			}
			catch(org.omg.zx.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
