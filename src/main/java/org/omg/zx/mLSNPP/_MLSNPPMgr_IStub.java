...
public class _MLSNPPMgr_IStub
	...
	implements org.omg.zx.mLSNPP.MLSNPPMgr_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.zx.mLSNPP.MLSNPPMgr_IOperations.class;
	...
	public void setTNANameForMLSNPP(org.omg.zx.globaldefs.NameAndStringValue_T[] mLSNPPName, org.omg.zx.mLSNPP.SNPTNAData_T[] sNPTNADataList, org.omg.zx.mLSNPP.SNPPTNAPair_T[] sNPPTNAPairList, java.lang.String tNAName, java.lang.String tNAGroupName, org.omg.zx.mLSNPP.MultiLayerSNPP_THolder multiLayerSNPP) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.zx.globaldefs.NVSList_THelper.write(_os,mLSNPPName);
				...
				_is = _invoke(_os);
				multiLayerSNPP.value = org.omg.zx.mLSNPP.MultiLayerSNPP_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
		...
		else
		{
			...
			try
			{
			_localServant.setTNANameForMLSNPP(mLSNPPName,sNPTNADataList,sNPPTNAPairList,tNAName,tNAGroupName,multiLayerSNPP);
			}
			finally
			{
				_servant_postinvoke(_so);
	...
	public void getMLSNPP(org.omg.zx.globaldefs.NameAndStringValue_T[] mLSNPPName, org.omg.zx.mLSNPP.MultiLayerSNPP_THolder theMLSNPP) throws org.omg.zx.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.zx.globaldefs.NVSList_THelper.write(_os,mLSNPPName);
				_is = _invoke(_os);
				theMLSNPP.value = org.omg.zx.mLSNPP.MultiLayerSNPP_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
