...
public abstract class HW_securityMgr_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.HW_securityMgr.HW_securityMgr_IOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "setNativeEMSName", new java.lang.Integer(0));
		m_opsHash.put ( "modifyPassword", new java.lang.Integer(1));
