...
public final class ResourceTypeQualifier_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.equipment.ResourceTypeQualifier_THelper.id(),"ResourceTypeQualifier_T",new String[]{"EQTROOM","CABINET","SHELF"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.equipment.ResourceTypeQualifier_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.equipment.ResourceTypeQualifier_T extract (final org.omg.CORBA.Any any)
	{
