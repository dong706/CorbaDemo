...
{
	public org.omg.hw.equipment.PhysicalLocationInfo_T[] value;

	public PhysicalLocationInfoList_THolder ()
	{
	}
	public PhysicalLocationInfoList_THolder (final org.omg.hw.equipment.PhysicalLocationInfo_T[] initial)
	{
		value = initial;
	}
