...
public final class Shelf_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.hw.equipment.Shelf_THelper.id(),"Shelf_T",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("name", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("equipmentRoomName", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("cabinetName", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("numbering", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("locationOfCabinet", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("memo", org.omg.CORBA.ORB.init().create_string_tc(0), null)});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.equipment.Shelf_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.equipment.Shelf_T extract (final org.omg.CORBA.Any any)
	{
	...
	public static org.omg.hw.equipment.Shelf_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.equipment.Shelf_T result = new org.omg.hw.equipment.Shelf_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.equipment.Shelf_T s)
	{
