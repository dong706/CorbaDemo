...
public final class EquipmentObjectTypeList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.equipment.EquipmentObjectTypeList_THelper.id(), "EquipmentObjectTypeList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.hw.equipment.EquipmentObjectType_THelper.type()));
		}
		return _type;
	}
