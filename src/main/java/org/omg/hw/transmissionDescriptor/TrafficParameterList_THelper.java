...
public final class TrafficParameterList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.transmissionDescriptor.TrafficParameterList_THelper.id(), "TrafficParameterList_T",org.omg.hw.globaldefs.NVSList_THelper.type());
		}
		return _type;
	}
