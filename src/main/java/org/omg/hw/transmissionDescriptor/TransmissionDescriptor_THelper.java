...
public final class TransmissionDescriptor_THelper
{
	...
	public static org.omg.hw.transmissionDescriptor.TransmissionDescriptor_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.transmissionDescriptor.TransmissionDescriptor_T result = new org.omg.hw.transmissionDescriptor.TransmissionDescriptor_T();
		...
		result.additionalTPInfo = org.omg.hw.globaldefs.NVSList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.transmissionDescriptor.TransmissionDescriptor_T s)
	{
		...
		org.omg.hw.globaldefs.NVSList_THelper.write(out,s.additionalTPInfo);
