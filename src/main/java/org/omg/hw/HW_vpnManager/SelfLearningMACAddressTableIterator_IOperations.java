...
public interface SelfLearningMACAddressTableIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, org.omg.hw.HW_vpnManager.SelfLearningMACAddressTableList_THolder tableList) throws org.omg.hw.globaldefs.ProcessingFailureException;
