...
public final class TrafficTrunkCreateData_THelper
{
	...
	public static org.omg.hw.HW_vpnManager.TrafficTrunkCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.HW_vpnManager.TrafficTrunkCreateData_T result = new org.omg.hw.HW_vpnManager.TrafficTrunkCreateData_T();
		...
		result.ipCCInclusions = org.omg.hw.HW_vpnManager.IPCrossConnectionList_THelper.read(in);
		result.additionalCreationInfo = org.omg.hw.globaldefs.NVSList_THelper.read(in);
		return result;
	}
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.HW_vpnManager.TrafficTrunkCreateData_T s)
	{
		...
		org.omg.hw.HW_vpnManager.IPCrossConnectionList_THelper.write(out,s.ipCCInclusions);
