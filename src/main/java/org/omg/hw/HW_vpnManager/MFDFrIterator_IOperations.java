...
public interface MFDFrIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, org.omg.hw.HW_vpnManager.MatrixFlowDomainFragmentList_THolder mfdfrList) throws org.omg.hw.globaldefs.ProcessingFailureException;
