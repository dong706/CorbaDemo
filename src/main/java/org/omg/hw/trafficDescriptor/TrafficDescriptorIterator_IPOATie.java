	...
	extends TrafficDescriptorIterator_IPOA
{
	...
	public org.omg.hw.trafficDescriptor.TrafficDescriptorIterator_I _this()
	{
		return org.omg.hw.trafficDescriptor.TrafficDescriptorIterator_IHelper.narrow(_this_object());
	}
	public org.omg.hw.trafficDescriptor.TrafficDescriptorIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.hw.trafficDescriptor.TrafficDescriptorIterator_IHelper.narrow(_this_object(orb));
	}
...
_delegate.destroy();
	...
	public boolean next_n(int how_many, org.omg.hw.trafficDescriptor.TrafficDescriptorList_THolder trafficDescList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
