...
public class _GuiCutThroughMgr_IStub
	...
	implements org.omg.hw.guiCutThrough.GuiCutThroughMgr_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.guiCutThrough.GuiCutThroughMgr_IOperations.class;
	...
	public void launchGCT(org.omg.hw.globaldefs.NameAndStringValue_T[] objectName, java.lang.String gctContext, org.omg.hw.globaldefs.NameAndStringValue_T[] userInfo, java.lang.String displayAddress, org.omg.hw.globaldefs.NameAndStringValue_T[] additionalInputInfo, org.omg.CORBA.BooleanHolder closingEnabled, org.omg.hw.globaldefs.NVSList_THolder additionalOutputInfo) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.hw.globaldefs.NVSList_THelper.write(_os,userInfo);
				_os.write_string(displayAddress);
				org.omg.hw.globaldefs.NVSList_THelper.write(_os,additionalInputInfo);
				_is = _invoke(_os);
				closingEnabled.value = _is.read_boolean();
				additionalOutputInfo.value = org.omg.hw.globaldefs.NVSList_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
	...
	public void getGCTProfileInfo(org.omg.hw.guiCutThrough.GCTProfileInfo_THolder gctProfileInfo) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				gctProfileInfo.value = org.omg.hw.guiCutThrough.GCTProfileInfo_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
