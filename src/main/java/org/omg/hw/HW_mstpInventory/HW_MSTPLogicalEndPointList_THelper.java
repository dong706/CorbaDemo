...
public final class HW_MSTPLogicalEndPointList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.HW_mstpInventory.HW_MSTPLogicalEndPointList_THelper.id(), "HW_MSTPLogicalEndPointList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.hw.HW_mstpInventory.HW_MSTPEndPoint_THelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.hw.HW_mstpInventory.HW_MSTPEndPoint_T[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.hw.HW_mstpInventory.HW_MSTPEndPoint_T[_l_result116];
