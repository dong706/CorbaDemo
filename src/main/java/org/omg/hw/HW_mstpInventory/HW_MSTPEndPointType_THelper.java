...
public final class HW_MSTPEndPointType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpInventory.HW_MSTPEndPointType_THelper.id(),"HW_MSTPEndPointType_T",new String[]{"HW_MEPT_NA","HW_MEPT_ATM","HW_MEPT_ATMTRUNK","HW_MEPT_ETH","HW_MEPT_ETHTRUNK","HW_MEPT_LP","HW_MEPT_RPR"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpInventory.HW_MSTPEndPointType_T s)
	{
		any.type(type());
