...
{
	public org.omg.hw.HW_mstpInventory.HW_MSTPEndPointType_T[] value;

	public HW_MSTPEndPointTypeList_THolder ()
	{
	}
	public HW_MSTPEndPointTypeList_THolder (final org.omg.hw.HW_mstpInventory.HW_MSTPEndPointType_T[] initial)
	{
		value = initial;
	}
