...
public final class HW_QosType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpInventory.HW_QosType_THelper.id(),"HW_QosType_T",new String[]{"HW_QT_NA","HW_QT_CAR","HW_QT_COS"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpInventory.HW_QosType_T s)
	{
		any.type(type());
