...
public abstract class HW_VirtualBridgeIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.HW_mstpInventory.HW_VirtualBridgeIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.hw.HW_mstpInventory.HW_VirtualBridgeList_THolder _arg1= new org.omg.hw.HW_mstpInventory.HW_VirtualBridgeList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				org.omg.hw.HW_mstpInventory.HW_VirtualBridgeList_THelper.write(_out,_arg1.value);
			}
