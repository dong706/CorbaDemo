...
public abstract class SequenceProxyPushSupplierPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "suspend_connection", new java.lang.Integer(3));
		m_opsHash.put ( "_get_lifetime_filter", new java.lang.Integer(4));
		m_opsHash.put ( "subscription_change", new java.lang.Integer(5));
		m_opsHash.put ( "_get_MyType", new java.lang.Integer(6));
		...
		m_opsHash.put ( "disconnect_sequence_push_supplier", new java.lang.Integer(10));
		...
		m_opsHash.put ( "_set_lifetime_filter", new java.lang.Integer(16));
		m_opsHash.put ( "remove_filter", new java.lang.Integer(17));
		m_opsHash.put ( "connect_sequence_push_consumer", new java.lang.Integer(18));
	...
	public org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplier _this()
	{
		return org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(_this_object());
	}
	public org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplier _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplierHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // disconnect_sequence_push_supplier
			{
				_out = handler.createReply();
			...
			case 18: // connect_sequence_push_consumer
			{
			try
			{
				org.omg.hw.CosNotifyComm.SequencePushConsumer _arg0=org.omg.hw.CosNotifyComm.SequencePushConsumerHelper.read(_input);
				_out = handler.createReply();
