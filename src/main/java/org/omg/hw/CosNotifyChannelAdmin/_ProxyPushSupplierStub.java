...
public class _ProxyPushSupplierStub
	...
	implements org.omg.hw.CosNotifyChannelAdmin.ProxyPushSupplier
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.CosNotifyChannelAdmin.ProxyPushSupplierOperations.class;
	...
	public void connect_any_push_consumer(org.omg.hw.CosEventComm.PushConsumer push_consumer) throws org.omg.hw.CosEventChannelAdmin.TypeError,org.omg.hw.CosEventChannelAdmin.AlreadyConnected
	{
		while(true)
		{
		if(! this._is_local())
