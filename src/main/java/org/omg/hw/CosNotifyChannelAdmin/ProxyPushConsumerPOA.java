...
public abstract class ProxyPushConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.CosNotifyChannelAdmin.ProxyPushConsumerOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 10: // connect_any_push_supplier
			{
			try
			{
				org.omg.hw.CosEventComm.PushSupplier _arg0=org.omg.hw.CosEventComm.PushSupplierHelper.read(_input);
				_out = handler.createReply();
