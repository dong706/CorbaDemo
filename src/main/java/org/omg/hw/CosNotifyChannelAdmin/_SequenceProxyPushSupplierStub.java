...
public class _SequenceProxyPushSupplierStub
	...
	implements org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplier
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushSupplierOperations.class;
	...
	public void connect_sequence_push_consumer(org.omg.hw.CosNotifyComm.SequencePushConsumer push_consumer) throws org.omg.hw.CosEventChannelAdmin.TypeError,org.omg.hw.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.hw.CosNotifyComm.SequencePushConsumerHelper.write(_os,push_consumer);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
