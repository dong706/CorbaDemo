...
public class _StructuredProxyPushConsumerStub
	...
	implements org.omg.hw.CosNotifyChannelAdmin.StructuredProxyPushConsumer
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.CosNotifyChannelAdmin.StructuredProxyPushConsumerOperations.class;
	...
	public void connect_structured_push_supplier(org.omg.hw.CosNotifyComm.StructuredPushSupplier push_supplier) throws org.omg.hw.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.hw.CosNotifyComm.StructuredPushSupplierHelper.write(_os,push_supplier);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
