...
public class _ProxyPushConsumerStub
	...
	implements org.omg.hw.CosNotifyChannelAdmin.ProxyPushConsumer
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.CosNotifyChannelAdmin.ProxyPushConsumerOperations.class;
	...
	public void connect_any_push_supplier(org.omg.hw.CosEventComm.PushSupplier push_supplier) throws org.omg.hw.CosEventChannelAdmin.AlreadyConnected
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.hw.CosEventComm.PushSupplierHelper.write(_os,push_supplier);
				_is = _invoke(_os);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
