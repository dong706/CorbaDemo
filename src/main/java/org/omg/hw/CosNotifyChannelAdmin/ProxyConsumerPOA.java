...
public abstract class ProxyConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.CosNotifyChannelAdmin.ProxyConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "remove_filter", new java.lang.Integer(6));
		m_opsHash.put ( "remove_all_filters", new java.lang.Integer(7));
		m_opsHash.put ( "get_all_filters", new java.lang.Integer(8));
		m_opsHash.put ( "_get_MyAdmin", new java.lang.Integer(9));
		m_opsHash.put ( "get_filter", new java.lang.Integer(10));
		m_opsHash.put ( "get_qos", new java.lang.Integer(11));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 7: // remove_all_filters
			{
				_out = handler.createReply();
				remove_all_filters();
				break;
			}
			case 8: // get_all_filters
			{
				_out = handler.createReply();
