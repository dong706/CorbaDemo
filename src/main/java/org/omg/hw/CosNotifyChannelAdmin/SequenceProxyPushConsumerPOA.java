...
public abstract class SequenceProxyPushConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushConsumerOperations
{
	static private final java.util.Hashtable m_opsHash = new java.util.Hashtable();
	static
	{
		m_opsHash.put ( "connect_sequence_push_supplier", new java.lang.Integer(0));
		...
		m_opsHash.put ( "obtain_subscription_types", new java.lang.Integer(4));
		m_opsHash.put ( "add_filter", new java.lang.Integer(5));
		m_opsHash.put ( "validate_qos", new java.lang.Integer(6));
	...
	public org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this()
	{
		return org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(_this_object());
	}
	public org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushConsumer _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.hw.CosNotifyChannelAdmin.SequenceProxyPushConsumerHelper.narrow(_this_object(orb));
	}
		...
		throws org.omg.CORBA.SystemException
	{
		...
		{
			case 0: // connect_sequence_push_supplier
			{
			try
			{
				org.omg.hw.CosNotifyComm.SequencePushSupplier _arg0=org.omg.hw.CosNotifyComm.SequencePushSupplierHelper.read(_input);
			...
			case 4: // obtain_subscription_types
			{
			...
			try
			{
				org.omg.hw.CosNotification.StructuredEvent[] _arg0=org.omg.hw.CosNotification.EventBatchHelper.read(_input);
				_out = handler.createReply();
