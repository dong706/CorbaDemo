...
public abstract class StructuredProxyPushSupplierPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.CosNotifyChannelAdmin.StructuredProxyPushSupplierOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "disconnect_structured_push_supplier", new java.lang.Integer(8));
		...
		m_opsHash.put ( "connect_structured_push_consumer", new java.lang.Integer(18));
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			case 8: // disconnect_structured_push_supplier
			{
				_out = handler.createReply();
			...
			case 18: // connect_structured_push_consumer
			{
			try
			{
				org.omg.hw.CosNotifyComm.StructuredPushConsumer _arg0=org.omg.hw.CosNotifyComm.StructuredPushConsumerHelper.read(_input);
				_out = handler.createReply();
