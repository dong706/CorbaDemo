...
public interface TopologicalLinkIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, org.omg.hw.topologicalLink.TopologicalLinkList_THolder topoLinkList) throws org.omg.hw.globaldefs.ProcessingFailureException;
