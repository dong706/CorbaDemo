...
public final class CollectTaskInfo_THelper
{
	...
	public static org.omg.hw.performance.CollectTaskInfo_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.performance.CollectTaskInfo_T result = new org.omg.hw.performance.CollectTaskInfo_T();
		result.m_TaskName=in.read_string();
		result.m_listPMTPSelect = org.omg.hw.globaldefs.NamingAttributesList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.performance.CollectTaskInfo_T s)
	{
		out.write_string(s.m_TaskName);
		org.omg.hw.globaldefs.NamingAttributesList_THelper.write(out,s.m_listPMTPSelect);
