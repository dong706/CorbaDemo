	...
	extends CCIterator_IPOA
{
	...
	public org.omg.hw.subnetworkConnection.CCIterator_I _this()
	{
		return org.omg.hw.subnetworkConnection.CCIterator_IHelper.narrow(_this_object());
	}
	public org.omg.hw.subnetworkConnection.CCIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.hw.subnetworkConnection.CCIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.omg.hw.subnetworkConnection.CrossConnectList_THolder ccList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
