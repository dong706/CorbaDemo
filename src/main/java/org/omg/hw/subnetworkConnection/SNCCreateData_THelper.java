...
public final class SNCCreateData_THelper
{
	...
	public static org.omg.hw.subnetworkConnection.SNCCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.subnetworkConnection.SNCCreateData_T result = new org.omg.hw.subnetworkConnection.SNCCreateData_T();
		...
		result.ccInclusions = org.omg.hw.subnetworkConnection.CrossConnectList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.subnetworkConnection.SNCCreateData_T s)
	{
		...
		org.omg.hw.subnetworkConnection.CrossConnectList_THelper.write(out,s.ccInclusions);
