...
public final class EthernetOAMCommandType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.flowDomain.EthernetOAMCommandType_THelper.id(),"EthernetOAMCommandType_T",new String[]{"EOCT_CC","EOCT_LB","EOCT_LT"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.flowDomain.EthernetOAMCommandType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.flowDomain.EthernetOAMCommandType_T extract (final org.omg.CORBA.Any any)
	{
