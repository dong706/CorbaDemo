...
public final class EthernetOAMPointDirection_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.flowDomain.EthernetOAMPointDirection_THelper.id(),"EthernetOAMPointDirection_T",new String[]{"EOPD_BI","EOPD_INGRESS","EOPD_EGRESS"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.flowDomain.EthernetOAMPointDirection_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.flowDomain.EthernetOAMPointDirection_T extract (final org.omg.CORBA.Any any)
	{
