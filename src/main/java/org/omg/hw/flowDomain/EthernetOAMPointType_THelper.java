...
public final class EthernetOAMPointType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.flowDomain.EthernetOAMPointType_THelper.id(),"EthernetOAMPointType_T",new String[]{"EOT_MEP","EOP_MIP"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.flowDomain.EthernetOAMPointType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.flowDomain.EthernetOAMPointType_T extract (final org.omg.CORBA.Any any)
	{
