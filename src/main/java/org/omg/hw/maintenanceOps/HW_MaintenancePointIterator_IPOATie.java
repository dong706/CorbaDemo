	...
	extends HW_MaintenancePointIterator_IPOA
{
	...
	public boolean next_n(int how_many, org.omg.hw.maintenanceOps.HW_MaintenancePointList_THolder mpList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
