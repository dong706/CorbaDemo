...
public class _CurrentMaintenanceOperationIterator_IStub
	...
	implements org.omg.hw.maintenanceOps.CurrentMaintenanceOperationIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.maintenanceOps.CurrentMaintenanceOperationIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.maintenanceOps.CurrentMaintenanceOperationList_THolder cMOList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				cMOList.value = org.omg.hw.maintenanceOps.CurrentMaintenanceOperationList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
