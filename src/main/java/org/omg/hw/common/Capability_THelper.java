...
public final class Capability_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.common.Capability_THelper.id(), "Capability_T",org.omg.hw.globaldefs.NameAndStringValue_THelper.type());
		}
		return _type;
	}
	...
	public static org.omg.hw.globaldefs.NameAndStringValue_T read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result=org.omg.hw.globaldefs.NameAndStringValue_THelper.read(_in);
		return _result;
	}

	public static void write (final org.omg.CORBA.portable.OutputStream _out, org.omg.hw.globaldefs.NameAndStringValue_T _s)
	{
		org.omg.hw.globaldefs.NameAndStringValue_THelper.write(_out,_s);
	}
}
