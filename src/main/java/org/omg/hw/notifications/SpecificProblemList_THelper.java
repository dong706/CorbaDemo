...
public final class SpecificProblemList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.notifications.SpecificProblemList_THelper.id(), "SpecificProblemList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.hw.notifications.SpecificProblem_THelper.type()));
		}
		return _type;
	}
