...
{
	public org.omg.hw.notifications.PerceivedSeverity_T[] value;

	public PerceivedSeverityList_THolder ()
	{
	}
	public PerceivedSeverityList_THolder (final org.omg.hw.notifications.PerceivedSeverity_T[] initial)
	{
		value = initial;
	}
