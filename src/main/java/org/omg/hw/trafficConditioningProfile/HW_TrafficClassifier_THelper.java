...
public final class HW_TrafficClassifier_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_struct_tc(org.omg.hw.trafficConditioningProfile.HW_TrafficClassifier_THelper.id(),"HW_TrafficClassifier_T",new org.omg.CORBA.StructMember[]{new org.omg.CORBA.StructMember("classifierID", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("logicalRelationType", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("action", org.omg.CORBA.ORB.init().create_string_tc(0), null),new org.omg.CORBA.StructMember("transmissionParams", org.omg.hw.transmissionParameters.LayeredParameterList_THelper.type(), null)});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.trafficConditioningProfile.HW_TrafficClassifier_T s)
	{
		any.type(type());
	...
	public static org.omg.hw.trafficConditioningProfile.HW_TrafficClassifier_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.trafficConditioningProfile.HW_TrafficClassifier_T result = new org.omg.hw.trafficConditioningProfile.HW_TrafficClassifier_T();
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.trafficConditioningProfile.HW_TrafficClassifier_T s)
	{
