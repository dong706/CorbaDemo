...
public class _EmsSession_IStub
	...
	implements org.omg.hw.emsSession.EmsSession_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.emsSession.EmsSession_IOperations.class;
	public org.omg.hw.session.Session_I associatedSession()
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				return org.omg.hw.session.Session_IHelper.read(_is);
			}
		...
		if( _so == null )
			...
			org.omg.hw.session.Session_I _result;
		try
		{
	...
	public void getManager(java.lang.String managerName, org.omg.hw.common.Common_IHolder managerInterface) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				managerInterface.value = org.omg.hw.common.Common_IHelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
	...
	public void getSupportedManagers(org.omg.hw.emsSession.EmsSession_IPackage.managerNames_THolder supportedManagerList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				supportedManagerList.value = org.omg.hw.emsSession.EmsSession_IPackage.managerNames_THelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
	...
	public void getEventChannel(org.omg.hw.CosNotifyChannelAdmin.EventChannelHolder eventChannel) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				_is = _invoke(_os);
				eventChannel.value = org.omg.hw.CosNotifyChannelAdmin.EventChannelHelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
