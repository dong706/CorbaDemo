...
public class _MFDFrIterator_IStub
	...
	implements org.omg.hw.flowDomainFragment_cmcc.MFDFrIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.flowDomainFragment_cmcc.MFDFrIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THolder mfdfrList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				mfdfrList.value = org.omg.hw.flowDomainFragment_cmcc.MatrixFlowDomainFragmentList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
