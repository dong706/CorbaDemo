...
public class _AlarmStaticInfoIterator_IStub
	...
	implements org.omg.hw.emsMgr.AlarmStaticInfoIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.emsMgr.AlarmStaticInfoIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.emsMgr.AlarmStaticInfoList_THolder alarmStaticInfoList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				alarmStaticInfoList.value = org.omg.hw.emsMgr.AlarmStaticInfoList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
