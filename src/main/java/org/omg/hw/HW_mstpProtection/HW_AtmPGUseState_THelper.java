...
public final class HW_AtmPGUseState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpProtection.HW_AtmPGUseState_THelper.id(),"HW_AtmPGUseState_T",new String[]{"HW_AUS_NA","HW_AUS_USED","HW_AUS_UNUSED"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpProtection.HW_AtmPGUseState_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.HW_mstpProtection.HW_AtmPGUseState_T extract (final org.omg.CORBA.Any any)
	{
