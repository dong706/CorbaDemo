...
public abstract class HW_RPRNodeIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.HW_mstpProtection.HW_RPRNodeIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.hw.HW_mstpProtection.HW_RPRNodeList_THolder _arg1= new org.omg.hw.HW_mstpProtection.HW_RPRNodeList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				org.omg.hw.HW_mstpProtection.HW_RPRNodeList_THelper.write(_out,_arg1.value);
			}
			catch(org.omg.hw.globaldefs.ProcessingFailureException _ex0)
			{
				_out = handler.createExceptionReply();
