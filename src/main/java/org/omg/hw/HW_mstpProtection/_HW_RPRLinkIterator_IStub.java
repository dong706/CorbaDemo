...
public class _HW_RPRLinkIterator_IStub
	...
	implements org.omg.hw.HW_mstpProtection.HW_RPRLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.HW_mstpProtection.HW_RPRLinkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.HW_mstpProtection.HW_RPRLinkInfoList_THolder rprLinkList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				rprLinkList.value = org.omg.hw.HW_mstpProtection.HW_RPRLinkInfoList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
