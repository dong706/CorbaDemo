...
public interface HW_RPRLinkIterator_IOperations
{
	/* constants */
	/* operations  */
	boolean next_n(int how_many, org.omg.hw.HW_mstpProtection.HW_RPRLinkInfoList_THolder rprLinkList) throws org.omg.hw.globaldefs.ProcessingFailureException;
