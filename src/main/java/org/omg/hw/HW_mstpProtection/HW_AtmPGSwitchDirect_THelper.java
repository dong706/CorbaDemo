...
public final class HW_AtmPGSwitchDirect_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpProtection.HW_AtmPGSwitchDirect_THelper.id(),"HW_AtmPGSwitchDirect_T",new String[]{"HW_ASD_NA","HW_ASD_SRC","HW_ASD_SNK","HW_ASD_BI"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpProtection.HW_AtmPGSwitchDirect_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.HW_mstpProtection.HW_AtmPGSwitchDirect_T extract (final org.omg.CORBA.Any any)
	{
