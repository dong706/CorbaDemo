...
public final class HW_AtmPGSwitchAction_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpProtection.HW_AtmPGSwitchAction_THelper.id(),"HW_AtmPGSwitchAction_T",new String[]{"HW_ASAT_NA","HW_ASAT_SWITCH","HW_ASAT_RESTORE"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpProtection.HW_AtmPGSwitchAction_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.HW_mstpProtection.HW_AtmPGSwitchAction_T extract (final org.omg.CORBA.Any any)
	{
