...
public abstract class SequencePushConsumerPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.CosNotifyComm.SequencePushConsumerOperations
{
	...
	static
	{
		...
		m_opsHash.put ( "push_structured_events", new java.lang.Integer(2));
	}
