...
public final class ConstraintIDSeqHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.CosNotifyFilter.ConstraintIDSeqHelper.id(), "ConstraintIDSeq",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.hw.CosNotifyFilter.ConstraintIDHelper.type()));
		}
		return _type;
	}
