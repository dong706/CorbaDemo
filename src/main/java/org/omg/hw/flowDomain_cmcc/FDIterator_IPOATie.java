	...
	extends FDIterator_IPOA
{
	...
	public org.omg.hw.flowDomain_cmcc.FDIterator_I _this()
	{
		return org.omg.hw.flowDomain_cmcc.FDIterator_IHelper.narrow(_this_object());
	}
	public org.omg.hw.flowDomain_cmcc.FDIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.hw.flowDomain_cmcc.FDIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.omg.hw.flowDomain_cmcc.FDList_THolder fdList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
