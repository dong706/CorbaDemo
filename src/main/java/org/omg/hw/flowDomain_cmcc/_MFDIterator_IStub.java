...
public class _MFDIterator_IStub
	...
	implements org.omg.hw.flowDomain_cmcc.MFDIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.flowDomain_cmcc.MFDIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.flowDomain_cmcc.MFDList_THolder mfdList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				mfdList.value = org.omg.hw.flowDomain_cmcc.MFDList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
