...
public final class MFDCreateData_THelper
{
	...
	public static org.omg.hw.flowDomain_cmcc.MFDCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.flowDomain_cmcc.MFDCreateData_T result = new org.omg.hw.flowDomain_cmcc.MFDCreateData_T();
		result.name = org.omg.hw.globaldefs.NVSList_THelper.read(in);
		result.userLabel=in.read_string();
		result.forceUniqueness=in.read_boolean();
		result.owner=in.read_string();
		result.networkAccessDomain=in.read_string();
		result.unassignedCPTPs = org.omg.hw.globaldefs.NamingAttributesList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.flowDomain_cmcc.MFDCreateData_T s)
	{
		...
		org.omg.hw.globaldefs.NamingAttributesList_THelper.write(out,s.unassignedCPTPs);
