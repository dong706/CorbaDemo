...
public final class FTPCreateData_THelper
{
	...
	public static org.omg.hw.flowDomain_cmcc.FTPCreateData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.flowDomain_cmcc.FTPCreateData_T result = new org.omg.hw.flowDomain_cmcc.FTPCreateData_T();
		...
		result.ingressTransmissionDescriptorName = org.omg.hw.globaldefs.NVSList_THelper.read(in);
		result.egressTransmissionDescriptorName = org.omg.hw.globaldefs.NVSList_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.flowDomain_cmcc.FTPCreateData_T s)
	{
		...
		org.omg.hw.globaldefs.NVSList_THelper.write(out,s.ingressTransmissionDescriptorName);
		org.omg.hw.globaldefs.NVSList_THelper.write(out,s.egressTransmissionDescriptorName);
