...
public class _EmsSessionFactory_IStub
	...
	implements org.omg.hw.emsSessionFactory.EmsSessionFactory_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.emsSessionFactory.EmsSessionFactory_IOperations.class;
	...
	public void getEmsSession(java.lang.String user, java.lang.String password, org.omg.hw.nmsSession.NmsSession_I client, org.omg.hw.emsSession.EmsSession_IHolder emsSessionInterface) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				org.omg.hw.nmsSession.NmsSession_IHelper.write(_os,client);
				_is = _invoke(_os);
				emsSessionInterface.value = org.omg.hw.emsSession.EmsSession_IHelper.read(_is);
				return;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
