...
public abstract class EmsSessionFactory_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.emsSessionFactory.EmsSessionFactory_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.hw.nmsSession.NmsSession_I _arg2=org.omg.hw.nmsSession.NmsSession_IHelper.read(_input);
				org.omg.hw.emsSession.EmsSession_IHolder _arg3= new org.omg.hw.emsSession.EmsSession_IHolder();
				_out = handler.createReply();
				getEmsSession(_arg0,_arg1,_arg2,_arg3);
				org.omg.hw.emsSession.EmsSession_IHelper.write(_out,_arg3.value);
			}
