...
public class _ProtectionSubnetworkIterator_IStub
	...
	implements org.omg.hw.protection.ProtectionSubnetworkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.protection.ProtectionSubnetworkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.protection.ProtectionSubnetworkList_THolder PGPList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				PGPList.value = org.omg.hw.protection.ProtectionSubnetworkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
