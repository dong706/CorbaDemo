...
public class _IPProtectionGroupIterator_IStub
	...
	implements org.omg.hw.protection.IPProtectionGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.protection.IPProtectionGroupIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.protection.IPProtectionGroupList_THolder pgpList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				pgpList.value = org.omg.hw.protection.IPProtectionGroupList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
