...
public final class ProtectionSubnetworkType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.protection.ProtectionSubnetworkType_THelper.id(),"ProtectionSubnetworkType_T",new String[]{"PSNT_MSP_1_PLUS_1","PSNT_MSP_M_FOR_N","PSNT_2_FIBER_ULSR","PSNT_2_FIBER_BLSR","PSNT_4_FIBER_BLSR","PSNT_USNCP","PSNT_BSNCP","PSNT_UPP","PSNT_BPP","PSNT_NP","PSNT_SNC_NODE","PSNT_NPL","PSNT_NPR"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.protection.ProtectionSubnetworkType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.protection.ProtectionSubnetworkType_T extract (final org.omg.CORBA.Any any)
	{
