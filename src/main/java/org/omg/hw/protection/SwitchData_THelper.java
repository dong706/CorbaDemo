...
public final class SwitchData_THelper
{
	...
	public static org.omg.hw.protection.SwitchData_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.protection.SwitchData_T result = new org.omg.hw.protection.SwitchData_T();
		result.protectionType=org.omg.hw.protection.ProtectionType_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.protection.SwitchData_T s)
	{
		org.omg.hw.protection.ProtectionType_THelper.write(out,s.protectionType);
