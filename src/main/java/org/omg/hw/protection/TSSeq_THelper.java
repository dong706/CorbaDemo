...
public final class TSSeq_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.protection.TSSeq_THelper.id(), "TSSeq_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.CORBA.ORB.init().get_primitive_tc(org.omg.CORBA.TCKind.from_int(4))));
		}
		return _type;
	}
	...
	public static short[] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new short[_l_result21];
	_in.read_ushort_array(_result,0,_l_result21);
		return _result;
	}
