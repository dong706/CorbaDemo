...
public class _HW_XPICGroupIterator_IStub
	...
	implements org.omg.hw.protection.HW_XPICGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.protection.HW_XPICGroupIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.protection.HW_XPICGroupList_THolder xpicGroupList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				xpicGroupList.value = org.omg.hw.protection.HW_XPICGroupList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
