...
public class _WDMProtectionGroupIterator_IStub
	...
	implements org.omg.hw.protection.WDMProtectionGroupIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.protection.WDMProtectionGroupIterator_IOperations.class;
	public boolean next_n(int how_many, org.omg.hw.protection.WDMProtectionGroupList_THolder pgpList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				pgpList.value = org.omg.hw.protection.WDMProtectionGroupList_THelper.read(_is);
				return _result;
			}
