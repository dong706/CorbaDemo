...
public final class FilterableEventBodyHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.CosNotification.FilterableEventBodyHelper.id(), "FilterableEventBody",org.omg.hw.CosNotification.PropertySeqHelper.type());
		}
		return _type;
	}
