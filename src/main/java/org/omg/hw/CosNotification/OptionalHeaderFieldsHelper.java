...
public final class OptionalHeaderFieldsHelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.CosNotification.OptionalHeaderFieldsHelper.id(), "OptionalHeaderFields",org.omg.hw.CosNotification.PropertySeqHelper.type());
		}
		return _type;
	}
