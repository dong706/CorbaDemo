...
public class _ELLinkIterator_IStub
	...
	implements org.omg.hw.encapsulationLayerLink.ELLinkIterator_I
{
	...
	public final static java.lang.Class _opsClass = org.omg.hw.encapsulationLayerLink.ELLinkIterator_IOperations.class;
	...
	public boolean next_n(int how_many, org.omg.hw.encapsulationLayerLink.ELLinkList_THolder ellList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
		...
		if(! this._is_local())
		{
			...
			try
			{
				...
				ellList.value = org.omg.hw.encapsulationLayerLink.ELLinkList_THelper.read(_is);
				return _result;
			}
			catch( org.omg.CORBA.portable.RemarshalException _rx ){}
			catch( org.omg.CORBA.portable.ApplicationException _ax )
