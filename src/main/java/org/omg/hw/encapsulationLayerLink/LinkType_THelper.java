...
public final class LinkType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.encapsulationLayerLink.LinkType_THelper.id(),"LinkType_T",new String[]{"LT_POINT_TO_POINT","LT_POINT_TO_MULTIPOINT","LT_MULTIPOINT"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.encapsulationLayerLink.LinkType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.encapsulationLayerLink.LinkType_T extract (final org.omg.CORBA.Any any)
	{
