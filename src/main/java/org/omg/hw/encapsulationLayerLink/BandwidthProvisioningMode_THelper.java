...
public final class BandwidthProvisioningMode_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.encapsulationLayerLink.BandwidthProvisioningMode_THelper.id(),"BandwidthProvisioningMode_T",new String[]{"BP_NONE","BP_AUTOMATIC","BP_MANUAL","BP_BY_CALL"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.encapsulationLayerLink.BandwidthProvisioningMode_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.encapsulationLayerLink.BandwidthProvisioningMode_T extract (final org.omg.CORBA.Any any)
	{
