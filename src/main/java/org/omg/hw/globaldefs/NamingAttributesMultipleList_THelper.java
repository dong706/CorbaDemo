...
public final class NamingAttributesMultipleList_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_alias_tc(org.omg.hw.globaldefs.NamingAttributesMultipleList_THelper.id(), "NamingAttributesMultipleList_T",org.omg.CORBA.ORB.init().create_sequence_tc(0, org.omg.hw.globaldefs.NamingAttributesList_THelper.type()));
		}
		return _type;
	}
	...
	public static org.omg.hw.globaldefs.NameAndStringValue_T[][][] read (final org.omg.CORBA.portable.InputStream _in)
	{
		...
		_result = new org.omg.hw.globaldefs.NameAndStringValue_T[_l_result2][][];
		for (int i=0;i<_result.length;i++)
		{
			_result[i] = org.omg.hw.globaldefs.NamingAttributesList_THelper.read(_in);
		}
	...
	public static void write (final org.omg.CORBA.portable.OutputStream _out, org.omg.hw.globaldefs.NameAndStringValue_T[][][] _s)
	{
		...
		{
			org.omg.hw.globaldefs.NamingAttributesList_THelper.write(_out,_s[i]);
		}
