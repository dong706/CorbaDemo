...
public final class TPConnectionState_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.terminationPoint.TPConnectionState_THelper.id(),"TPConnectionState_T",new String[]{"TPCS_NA","TPCS_SOURCE_CONNECTED","TPCS_SINK_CONNECTED","TPCS_BI_CONNECTED","TPCS_NOT_CONNECTED"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.terminationPoint.TPConnectionState_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.terminationPoint.TPConnectionState_T extract (final org.omg.CORBA.Any any)
	{
