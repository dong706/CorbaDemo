...
public final class TerminationPoint_THelper
{
	...
	public static org.omg.hw.terminationPoint.TerminationPoint_T read (final org.omg.CORBA.portable.InputStream in)
	{
		org.omg.hw.terminationPoint.TerminationPoint_T result = new org.omg.hw.terminationPoint.TerminationPoint_T();
		...
		result.type=org.omg.hw.terminationPoint.TPType_THelper.read(in);
	...
	public static void write (final org.omg.CORBA.portable.OutputStream out, final org.omg.hw.terminationPoint.TerminationPoint_T s)
	{
		...
		org.omg.hw.terminationPoint.TPType_THelper.write(out,s.type);
