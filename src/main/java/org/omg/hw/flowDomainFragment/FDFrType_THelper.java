...
public final class FDFrType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.flowDomainFragment.FDFrType_THelper.id(),"FDFrType_T",new String[]{"FDFRT_POINT_TO_POINT","FDFRT_POINT_TO_MULTIPOINT","FDFRT_MULTIPOINT"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.flowDomainFragment.FDFrType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.flowDomainFragment.FDFrType_T extract (final org.omg.CORBA.Any any)
	{
