	...
	extends FDFrIterator_IPOA
{
	...
	public org.omg.hw.flowDomainFragment.FDFrIterator_I _this()
	{
		return org.omg.hw.flowDomainFragment.FDFrIterator_IHelper.narrow(_this_object());
	}
	public org.omg.hw.flowDomainFragment.FDFrIterator_I _this(org.omg.CORBA.ORB orb)
	{
		return org.omg.hw.flowDomainFragment.FDFrIterator_IHelper.narrow(_this_object(orb));
	}
	...
	public boolean next_n(int how_many, org.omg.hw.flowDomainFragment.FDFrList_THolder fdfrList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
