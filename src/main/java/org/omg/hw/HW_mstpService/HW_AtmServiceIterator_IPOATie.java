	...
	extends HW_AtmServiceIterator_IPOA
{
	...
	public boolean next_n(int how_many, org.omg.hw.HW_mstpService.HW_AtmServiceList_THolder serviceList) throws org.omg.hw.globaldefs.ProcessingFailureException
	{
