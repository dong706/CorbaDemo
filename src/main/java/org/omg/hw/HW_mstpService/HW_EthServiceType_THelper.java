...
public final class HW_EthServiceType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpService.HW_EthServiceType_THelper.id(),"HW_EthServiceType_T",new String[]{"HW_EST_NA","HW_EST_EPL","HW_EST_EVPL","HW_EST_EPLAN","HW_EST_EVPLAN"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpService.HW_EthServiceType_T s)
	{
		any.type(type());
