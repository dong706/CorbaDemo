...
{
	public org.omg.hw.HW_mstpService.HW_EthServiceType_T[] value;

	public HW_EthServiceTypeList_THolder ()
	{
	}
	public HW_EthServiceTypeList_THolder (final org.omg.hw.HW_mstpService.HW_EthServiceType_T[] initial)
	{
		value = initial;
	}
