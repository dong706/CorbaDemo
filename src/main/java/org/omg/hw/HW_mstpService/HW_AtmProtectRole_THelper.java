...
public final class HW_AtmProtectRole_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpService.HW_AtmProtectRole_THelper.id(),"HW_AtmProtectRole_T",new String[]{"HW_APR_NA","HW_APR_WORKING","HW_APR_PROTECTING"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpService.HW_AtmProtectRole_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.HW_mstpService.HW_AtmProtectRole_T extract (final org.omg.CORBA.Any any)
	{
