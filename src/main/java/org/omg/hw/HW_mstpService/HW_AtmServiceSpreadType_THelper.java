...
public final class HW_AtmServiceSpreadType_THelper
{
	...
	public static org.omg.CORBA.TypeCode type ()
	{
		if (_type == null)
		{
			_type = org.omg.CORBA.ORB.init().create_enum_tc(org.omg.hw.HW_mstpService.HW_AtmServiceSpreadType_THelper.id(),"HW_AtmServiceSpreadType_T",new String[]{"HW_ASST_NA","HW_ASST_P2P","HW_ASST_P2MPROOT","HW_ASST_P2MPLEAF"});
		}
		return _type;
	}

	public static void insert (final org.omg.CORBA.Any any, final org.omg.hw.HW_mstpService.HW_AtmServiceSpreadType_T s)
	{
		any.type(type());
		write( any.create_output_stream(),s);
	}

	public static org.omg.hw.HW_mstpService.HW_AtmServiceSpreadType_T extract (final org.omg.CORBA.Any any)
	{
