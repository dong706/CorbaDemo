...
{
	public org.omg.hw.HW_mstpService.HW_AtmServiceType_T[] value;

	public HW_AtmServiceTypeList_THolder ()
	{
	}
	public HW_AtmServiceTypeList_THolder (final org.omg.hw.HW_mstpService.HW_AtmServiceType_T[] initial)
	{
		value = initial;
	}
