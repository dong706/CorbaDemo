...
public abstract class TrailNtwProtectionIterator_IPOA
	...
	implements org.omg.CORBA.portable.InvokeHandler, org.omg.hw.trailNtwProtection.TrailNtwProtectionIterator_IOperations
{
		...
		throws org.omg.CORBA.SystemException
	{
		...
		switch ( opsIndex.intValue() )
		{
			...
			try
			{
				...
				org.omg.hw.trailNtwProtection.TrailNtwProtectionList_THolder _arg1= new org.omg.hw.trailNtwProtection.TrailNtwProtectionList_THolder();
				_out = handler.createReply();
				_out.write_boolean(next_n(_arg0,_arg1));
				org.omg.hw.trailNtwProtection.TrailNtwProtectionList_THelper.write(_out,_arg1.value);
			}
